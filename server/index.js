...
// 2. CREATE A NEW NOTE
// Inserts a new note title, content and color into the MySQL database.
app.post('/api/notes', async (req, res) => {
  const { title, content, color } = req.body;
  const noteColor = color || 'slate';
  ...
  try {
    let result;
    let finalColor = noteColor;
    try {
      // Try to insert with color field
      ...
      // Fallback: If table doesn't have color column, insert without it
